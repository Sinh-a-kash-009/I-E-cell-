...
const {mutate}=useMutation({
    ...
    <div className="bg-slate-950 text-white h-screen w-screen overflow-auto">
        <Navbar path={path}/>
         ...
         <h1 className="text-6xl relative top-[-341px] font-extrabold bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent animate-bounce">Contact Us</h1>
